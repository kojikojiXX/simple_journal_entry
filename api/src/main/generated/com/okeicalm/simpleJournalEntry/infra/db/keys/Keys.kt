...
val JOURNALS_IBFK_1: ForeignKey<JournalsRecord, UsersRecord> = Internal.createForeignKey(Journals.JOURNALS, DSL.name("journals_ibfk_1"), arrayOf(Journals.JOURNALS.USER_ID), com.okeicalm.simpleJournalEntry.infra.db.keys.KEY_USERS_PRIMARY, arrayOf(Users.USERS.ID), true)
